    ...
    <div class="page">
        <div class="container">
            <div class="header-row">
                ...
                <span class="badge">{{ ($managers ?? collect())->count() }} managers</span>
            </div>

            <div class="filter-panel">
                <form method="GET" action="{{ route('managers.index') }}" class="filter-grid">
                    ...
                    <div class="filter-field">
                        <label for="experience_order">Experience Order</label>
                        <select name="experience_order" id="experience_order">
                            <option value="team" @selected(($experienceOrder ?? 'team') === 'team')>Team Name</option>
                            <option value="high_low" @selected(($experienceOrder ?? '') === 'high_low')>Highest Experience First</option>
                        </select>
                    </div>

                    <div class="filter-actions">
                        <button type="submit" class="btn">Apply Filters</button>
                        <a href="{{ route('managers.index') }}" class="btn">Reset</a>
                    </div>
                </form>
            </div>
            ...
            @else
                <p class="empty">No managers matched the selected filter.</p>
            @endif
        </div>
    </div>
</div>
